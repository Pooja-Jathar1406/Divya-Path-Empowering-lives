              ...
              {score !== null && score > 20 && (
                <div className=" row  d-flex justify-content-center align-items-center text-center">
                  <div className="col-md-10 p-2 pt-5">
                    ...
                    <p>
                      आपके स्कोर के आधार पर, आप एक पेशेवर मानसिक स्वास्थ्य
                      प्रदाता से संपर्क करना चाहते हो सकते हैं। कृपया अधिक
                      जानकारी के लिए एक मानसिक स्वास्थ्य प्रदाता से संपर्क करें।
                    </p>
                    <a
