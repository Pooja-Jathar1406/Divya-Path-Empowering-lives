    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/govtSchemesH"
            element={<GovtSchemesH></GovtSchemesH>}></Route>
          <Route
            path="/add-grievH"
            element={<GrievanSystemH></GrievanSystemH>}></Route>
          <Route path="/jobsH" element={<JobUserH></JobUserH>}></Route>
          <Route path="/skillsH" element={<SkillsH></SkillsH>}></Route>
          <Route
            path="/courseinfoH"
            element={<CourseInfoH></CourseInfoH>}></Route>
          <Route
            path="/mentalhealthH"
            element={<MentalHealthTestH></MentalHealthTestH>}></Route>
        </Routes>
